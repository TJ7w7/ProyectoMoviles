...
class HomeRecolector : Fragment() {
    ...
    companion object {
        private const val TAG = "HomeRecolector"
    }
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_home_recolector, container, false)
    ...
    private fun mostrarDatosUsuario() {
        usuarioActual?.let { usuario ->
            txtBienvenida.text = "¡Hola, ${usuario.nombres.split(" ")[0]}!"
    ...
    private fun cargarAsignacionActual() {
        ...
        Log.d(TAG, "Buscando asignación para usuario: $userId")
    ...
    private fun mostrarAsignacion() {
        asignacionActual?.let { asignacion ->
            Log.d(TAG, "Mostrando asignación: ${asignacion.rutaNombre}")
    ...
    private fun mostrarSinAsignacion() {
        ...
        Log.d(TAG, "Mostrando estado sin asignación")
    ...
    private fun cargarDetalleVehiculo(vehiculoId: String) {
        db.collection("vehiculos")
            ...
            .addOnFailureListener { e ->
                Log.e(TAG, "Error al cargar vehículo: ${e.message}", e)
            }
    }
